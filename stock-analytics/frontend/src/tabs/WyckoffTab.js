            ...
            ${computing
              ...
              ${phaseFilter === p
                      ...
                      ${i % 2 === 0 ? '' : 'bg-[#161b22]/30'}`, style: { borderLeft: `4px solid ${row.signal === 'BUY' ? '#34d399' :
                                ...
                                })] })] }) })), _jsx("p", { className: "text-xs text-[#8b949e]/40 text-right", children: "Wyckoff signals \u2014 HOSE + HNX \u00B7 updated daily after market close \u00B7 not financial advice" }), detail && (_jsx(SymbolModal, { symbol: detail.symbol, name: detail.name, onClose: () => setDetail(null) }))] }));
}
